...
$postData = [
  ...
  'tipo_ordenacao' => 'data_documento',
  'modo_ordenacao' => 'desc',
  'nao_gerar_os' => '1'
];

curl_setopt_array($curl, array(
  CURLOPT_URL => $config['sgp_url'] . '/api/ura/fatura2via/',
  ...
  CURLOPT_POSTFIELDS => $postData, // API doc shows form-data style array in example, but verify if json needed. Using array based on example.
));
